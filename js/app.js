...
function Shop(locationName,minCust ,maxCust ,aveCust ,custHour ,cookiesHour, TOTAL){
...
Shop.prototype.custHour=function () {
  this.custHour=getRandomIntInclusive(23,65)
  
}


let seattle = new Shop('Seattle', 23 , 65, 6.3 ,[], [],0)
console.log(seattle);
